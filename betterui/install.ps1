...
#   3. 注册登录计划任务 OpenCodeBetterUI：官方更新后自动重新注入，插件不会消失
#
# 用法（在 betterui 目录下）：
...
$copied = @("betterui.js", "patch.mjs", "watch.mjs", "launch-hidden.ps1", "uninstall.ps1", "install.ps1", "README.md")

Write-Host ""
Write-Host "betterUI · OpenCode 桌面端界面增强（会话分组 + 标题栏菜单栏）" -ForegroundColor Cyan
Write-Host "----------------------------------------------------------------"
