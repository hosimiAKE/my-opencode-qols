...
const LOG = path.join(HERE, "homelander.log");
const INTERVAL_MS = Number(process.env.HOMELANDER_INTERVAL_MS || 20000);
...
function log(msg) {
  ...
  if (!process.env.HOMELANDER_QUIET) console.log(line);
}
